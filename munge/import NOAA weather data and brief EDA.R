...
write.csv(noaa.weather.stations, paste(my.path,'noaa.weather.stations.csv',sep='\\'),row.names = FALSE)
...
stn.zcta <- read.csv(paste(base.path,'data','noaa_weather_stations_zcta.csv',sep="\\"),stringsAsFactors = FALSE)
stn.blkgrp <- read.csv(paste(base.path,'data','noaa_weather_stations_BG2018.csv',sep="\\"),stringsAsFactors = FALSE)
stn.community.area <- read.csv(paste(base.path,'data','noaa_weather_stations_CommArea.csv',sep="\\"),stringsAsFactors = FALSE)
